...
def main(args):
    ...
    if ckpt_path is None:
        ...
        # Load checkpoint with weights_only=False to allow loading argparse.Namespace
    ...
    vae = AutoencoderKL.from_pretrained(f"/root/autodl-tmp/sd-vae-ft-{args.vae}").to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample-dir", type=str, default="samples_ema")
