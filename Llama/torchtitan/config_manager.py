...
class JobConfig:
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
            ...
            type=str,
            default=None,
            help="Path to pretrained model weights for SFT training",
        )
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=None,
            help="Number of epochs to train (overrides steps if provided)",
        )
        self.parser.add_argument(
            ...
            help="Learning rate scheduler type: cosine or linear decay",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            ...
            type=str,
            default="steps",
            help="Checkpointing interval unit of measurement ['step', 'seconds', 'epochs']",
        )
        self.parser.add_argument(
            "--checkpoint.interval",
            type=int,
            default=500,
            help="Checkpointing interval, in steps, seconds, or epochs depending on --checkpoint.interval_type",
        )
        self.parser.add_argument(
            "--checkpoint.save_epoch_checkpoints",
            action="store_true",
            help="Save checkpoint at the end of each epoch (in addition to interval-based checkpoints)",
        )
        self.parser.add_argument(
    ...
    def to_dict(self):
        ...
        for k, v in res.items():
            d = dict(type(v).__dict__)
            d = {k: v for k, v in d.items() if not (k.startswith("__") and k.endswith("__"))}
            res[k] = d
        return res
